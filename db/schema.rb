...
ActiveRecord::Schema[7.0].define(version: 2022_10_06_111548) do
  ...
  create_table "blogs", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.bigint "master_categories_id"
    t.integer "visit_count", default: 0
    t.string "tag_list"
    t.index ["master_categories_id"], name: "index_blogs_on_master_categories_id"
  ...
  create_table "user_visit_blogs", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "blog_id"
    t.bigint "user_id"
    t.index ["blog_id"], name: "index_user_visit_blogs_on_blog_id"
    t.index ["user_id"], name: "index_user_visit_blogs_on_user_id"
  end
  ...
  add_foreign_key "user_visit_blogs", "blogs"
  add_foreign_key "user_visit_blogs", "users"
end
